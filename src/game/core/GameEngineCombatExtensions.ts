    ...
    if (result.success) {
      ...
      if (this.chargeAcPenaltyActive.has(nextEntityId)) {
        ...
        if (entity) {
          this.setState({
            ...this.getState(),
            entities: this.getState().entities.map(item => item.id === nextEntityId
